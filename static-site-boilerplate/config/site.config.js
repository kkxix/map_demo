...
const config = {
  ...
  site_name: 'Interactive Map demo',

  // Your website's description, used for favicon meta tags
  site_description: 'Demo the map tool ',

  // Your website's URL, used for sitemap
  site_url: 'https://kkxix.github.io/interactive_map/demo/static-site-boilerplate/src.github.io',
